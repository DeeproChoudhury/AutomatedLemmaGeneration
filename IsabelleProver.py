...
class IsabelleEnv(gym.Env):
    ...
    def get_isabelle_process(self, server_port):
        ...
        return SubprocessMonitor(
            ...
            # cwd=os.path.abspath("/local/scratch/dc755/environment/LEGO-Prover/lego_prover/env/Portal-to-ISAbelle"),
            cwd=os.path.abspath("/local/scratch/dc755/Portal-to-ISAbelle"),
...
if __name__ == "__main__":
    ...
    env = IsabelleEnv(logger=logger, isabelle_path="/local/scratch/dc755/Isabelle2022/")
    env.reset()
    code = r"""
theory Scratch
imports Main
